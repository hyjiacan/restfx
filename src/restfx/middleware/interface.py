...
class MiddlewareBase(ABC):
    ...
    @classmethod
    @abstractmethod
    def process_request(cls, request, meta, **kwargs):
        """
    ...
    @classmethod
    @abstractmethod
    def process_invoke(cls, request, meta, **kwargs):
        """
    ...
    @classmethod
    @abstractmethod
    def process_return(cls, request, meta, data, **kwargs):
        """
        在路由函数调用后，对其返回值进行处理
        :param request:
        :type request: HttpRequest
    ...
    @classmethod
    @abstractmethod
    def process_response(cls, request, meta, response, **kwargs):
        """
